...
class FormProcessorTest(TestCase):
    ...
    def test_process_form_document_success(self):
        ...
        self.assertEqual(validation_rules[0].error_message, "Title must be at least 5 characters long")
    ...
    def test_form_processor_result_initialization(self):
        ...
        result = FormProcessorResult(success=False, form_definition=form_def, errors=errors)
        self.assertFalse(result.success)
    ...
    def test_update_existing_form(self):
        ...
        original_form_id = result.form_definition.id
        original_form_name = result.form_definition.name
        
        # Now update the form with new data
        updated_document = self.valid_document.copy()
        updated_document["id"] = str(original_form_id)
        updated_document["name"] = "Updated Test Form"
        ...
        form_def = result.form_definition
        self.assertEqual(form_def.id, original_form_id)

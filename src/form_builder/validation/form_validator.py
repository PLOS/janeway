...
class FormValidator:
    ...
    def __init__(self, schema_path: str = None):
        ...
        if schema_path is None:
            ...
            self.schema_path = os.path.join(
                os.path.dirname(__file__), "..", "schema", "form_schema.json"
            )
        else:
    ...
    def _load_schema(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise json.JSONDecodeError(
                f"Invalid JSON in schema file: {e.msg}", e.doc, e.pos
            )
    ...
    def validate_form_document_file(self, file_path: str) -> Tuple[bool, List[str]]:
        ...
        try:
            ...
            return False, [
                f"Unexpected error while reading form document file: {str(e)}"
            ]
